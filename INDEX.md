...
Add **one line** for your recipe in the section that fits it best. Keep the
list alphabetical by recipe name, and link to your file.

This file is shared by the whole class. Expect merge conflicts — resolving one
is part of the assignment.

Format: `- [Recipe Name](recipes/yourlastname.md) — one short phrase. *(Your Name)*`
